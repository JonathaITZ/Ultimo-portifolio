      ...
      <main className="w-full max-w-7xl mx-auto px-6 py-10 flex-grow flex flex-col">
        ...
        >
          ...
          <div className="w-full lg:w-2/5 text-left flex flex-col justify-center">
            ...
            {project.repoUrl && (
              <a href={project.repoUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 mb-6 rounded-full bg-cyan-500/10 border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 transition-all text-sm font-bold tracking-wide">
